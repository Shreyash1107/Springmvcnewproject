                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mt-4">
                            ...
                            <input type="text" class="form-control" id="inputid" name="Eid" value="${Eid}" aria-describedby="evid" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mt-4">
                    ...
                    <!-- Add button directly in front of Time input -->
                    <div class="col-md-4 d-flex align-items-end mt-4">
                        <button type="submit" class="btn btn-info w-50">Update Event</button>
                    </div>
                </div>
            </div>
        </form>
