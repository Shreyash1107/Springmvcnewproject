...
<body>
	...
	<div class="sidebar">
		...
		<a href="<c:url value='/department' />">Department Module</a> <a
			href="<c:url value='/btchmodel' />">Batch Module</a> <a
			href="<c:url value='/alumni' />">Alumni Module</a> <a
			href="<c:url value='/events' />">Event Module</a> <a
			href="<c:url value='/feedbackpage' />">Feedback Module</a> <a
	...
	<div class="content">
		...
		<form name="frm" action="<c:url value='/department' />" method="POST"
			class="mt-4" onsubmit="return validateDeptName()">
			<div class="row g-3">
				<div class="col-md-4">
					<label for="exampleInputdept" class="form-label">Department
						Name</label> <input type="text" class="form-control" id="txtDept"
						name="dept_name" placeholder="Enter Department" autocomplete="off">
					...
					<c:forEach var="dept" items="${deptlist}">
						<tr>
							...
							<td><a href="javascript:void(0);" class="btn btn-warning"
								onclick="confirmUpdate(${dept.dept_id}, '${dept.dept_name}')">
									<i class="fas fa-pencil-alt"></i>
							</a></td>
							<td><a href="javascript:void(0);" class="btn btn-danger"
								onclick="confirmDelete(${dept.dept_id})"> <i
