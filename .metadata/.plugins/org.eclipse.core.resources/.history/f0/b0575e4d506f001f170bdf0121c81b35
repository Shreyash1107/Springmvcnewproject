...
<body>
    ...
    <div class="content">
        ...
        <form name="frm" action="finalupdatebatches" method="GET" class="mt-4" onsubmit="return validateBatchForm()">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="batch_year" id="passoutYear" value="${batch_year}" placeholder="Enter Passout Batch" autocomplete="off">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="dept_id" id="deptSelect">
                        <c:forEach var="depart" items="${d}">
                            <option value="${depart.getDept_id()}" ${depart.getDept_id() == dept_id ? 'selected' : ''}>
                                ${depart.getDept_name()}
                            </option>
                        </c:forEach>
                    </select>
                    ...
                    <tbody>
                        <c:forEach var="batch" items="${v}">
                            <tr>
                                ...
                                <td>
                                    <a href="updatebatches?bid=${batch.getBid()}&batch_year=${batch.getBatch_year()}&dept_id=${batch.getDept_id()}" class="btn btn-warning">Update</a>
                                </td>
                                <td>
                                    <a href="remove?bid=${batch.getBid()}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
