    ...
    <div class="content">
        ...
        <form name="frm" id="frm" action="finalupdatebatch" method="POST">
            <div class="row mt-4">
                ...
                <!-- Passout Batch Input Field -->
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="txtBatch">Passout Batch</label>
                        <input type="text" name="batch_year" id="txtBatch" class="form-control mt-2" value="${batch_year}" placeholder="Enter Passout Batch" onkeyup="validateBatch()" autocomplete="off">
                    ...
                    <tbody>
                        <c:forEach var="batch" items="${v}">
                            <tr>
                                ...
                                <td>
                                    <a href="updatebatches?bid=${batch.getBid()}&batch_year=${batch.getBatch_year()}&dept_id=${batch.getDept_id()}" class="btn btn-warning" role="button">Update</a>
                                </td>
                                <td>
                                    <a href="remove?bid=${batch.getBid()}" class="btn btn-danger" role="button">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
